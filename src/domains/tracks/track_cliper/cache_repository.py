"""
Модуль `cache_repository.py` содержит реализацию репозитория для работы с кэшем временных сообщений, связанных с обработкой аудиообрезки треков.

Обеспечивает хранение идентификаторов сообщений в Redis для последующей очистки после завершения операций обработки аудиофайлов.
"""
